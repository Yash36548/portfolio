        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <span className="contact_card-data">yashup5974@gmail.com</span>

              <a href="mailto:yashup5974@gmail.com" className="contact_button">
                Write me{" "}
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">Rahul Patel</span>

              <a
                href="https://www.facebook.com/profile.php?id=100077889603756"
                className="contact_button"
              >
                Write me{" "}
                <i className="bx bx-right-arrow-alt contact_button-icon"></i>
